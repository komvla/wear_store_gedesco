...
export const getProduct = (id: number) => `https://fakestoreapi.com/products/${id}`
...
export const getProductsByCategory = (category: string) => `https://fakestoreapi.com/products/category/${category}`
